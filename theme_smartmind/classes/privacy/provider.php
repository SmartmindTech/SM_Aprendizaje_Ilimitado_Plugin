...
/**
 * Privacy Subsystem implementation for theme_smartmind.
 *
...
namespace theme_smartmind\privacy;
...
class provider implements
    ...
    public static function export_user_preferences(int $userid) {
        ...
        if (isset($draweropenindexpref)) {
            $preferencestring = get_string('privacy:drawerindexclosed', 'theme_smartmind');
            if ($draweropenindexpref == 1) {
                $preferencestring = get_string('privacy:drawerindexopen', 'theme_smartmind');
            }
        ...
        if (isset($draweropenblockpref)) {
            $preferencestring = get_string('privacy:drawerblockclosed', 'theme_smartmind');
            if ($draweropenblockpref == 1) {
                $preferencestring = get_string('privacy:drawerblockopen', 'theme_smartmind');
            }
            \core_privacy\local\request\writer::export_user_preference(
                'theme_smartmind',
