 ...
 *
 * @module     theme_smartmind/drawers
...
export default class Drawers {
     ...
     *
     * @static
     * @property {String} drawerShow See {@link event:theme_smartmind/drawers:show}
     * @property {String} drawerShown See {@link event:theme_smartmind/drawers:shown}
     * @property {String} drawerHide See {@link event:theme_smartmind/drawers:hide}
     * @property {String} drawerHidden See {@link event:theme_smartmind/drawers:hidden}
     */
    static eventTypes = {
        /**
         * An event triggered before a drawer is shown.
         *
         * @event theme_smartmind/drawers:show
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be opened.
         */
        drawerShow: 'theme_smartmind/drawers:show',

        /**
         * An event triggered after a drawer is shown.
         *
         * @event theme_smartmind/drawers:shown
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be opened.
         */
        drawerShown: 'theme_smartmind/drawers:shown',

        /**
         * An event triggered before a drawer is hidden.
         *
         * @event theme_smartmind/drawers:hide
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that will be hidden.
         */
        drawerHide: 'theme_smartmind/drawers:hide',

        /**
         * An event triggered after a drawer is hidden.
         *
         * @event theme_smartmind/drawers:hidden
         * @type {CustomEvent}
         * @property {HTMLElement} target The drawer that was be hidden.
         */
        drawerHidden: 'theme_smartmind/drawers:hidden',
    };
     ...
     * @returns {module:theme_smartmind/drawers}
     */
    ...
    openDrawer({focusOnCloseButton = true, setUserPref = true} = {}) {
        ...
        const pendingPromise = new Pending('theme_smartmind/drawers:open');
     ...
     */
        ...
        const pendingPromise = new Pending('theme_smartmind/drawers:close');
     ...
     *
     * @param {module:theme_smartmind/drawers} comparisonInstance
     */
