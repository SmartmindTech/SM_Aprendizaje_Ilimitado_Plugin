...
$THEME->name = 'smartmind';
$THEME->sheets = [];
$THEME->editor_sheets = [];
$THEME->editor_scss = ['editor'];
$THEME->usefallback = true;
$THEME->scss = function($theme) {
    return theme_smartmind_get_main_scss_content($theme);
};
...
$THEME->layouts = [
    ...
    // My dashboard page — uses its own layout + template.
    'mydashboard' => array(
...
$THEME->extrascsscallback = 'theme_smartmind_get_extra_scss';
$THEME->prescsscallback = 'theme_smartmind_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_smartmind_get_precompiled_css';
