...
$string['coursemgmt_sharepoint']      = 'Importar desde SharePoint';
$string['coursemgmt_sharepoint_desc'] = 'Importar un curso completo desde SharePoint';
...
$string['sp_heading']                = 'Integracion SharePoint';
$string['sp_courseloader_button']     = 'Abrir cargador de cursos';
$string['sp_courseloader_button_desc'] = 'Importar cursos automaticamente desde una carpeta de SharePoint.';
$string['sp_tenant_id']              = 'Azure AD Tenant ID';
$string['sp_tenant_id_desc']         = 'ID del tenant de Azure Active Directory (formato GUID).';
$string['sp_client_id']              = 'Azure AD Client ID';
$string['sp_client_id_desc']         = 'Application (client) ID de la App Registration en Azure AD.';
$string['sp_client_secret']          = 'Azure AD Client Secret';
$string['sp_client_secret_desc']     = 'Secreto de cliente de la App Registration.';
$string['sp_site_url']               = 'URL del sitio SharePoint';
$string['sp_site_url_desc']          = 'URL base del sitio SharePoint (ej: https://tuorg.sharepoint.com/sites/LMS).';
$string['courseloader_title']         = 'Cargador de cursos desde SharePoint';
$string['courseloader_subtitle']      = 'Pega la URL de una carpeta de SharePoint para analizar su contenido e importar el curso automaticamente.';
$string['courseloader_folder_url']    = 'URL de la carpeta en SharePoint';
$string['courseloader_folder_url_placeholder'] = 'https://tuorg.sharepoint.com/sites/LMS/Shared Documents/Cursos/CODIGO_CURSO';
$string['courseloader_category']      = 'Categoria de destino';
$string['courseloader_scan']          = 'Escanear carpeta';
$string['courseloader_import']        = 'Importar curso';
$string['courseloader_scanning']      = 'Escaneando carpeta en SharePoint...';
$string['courseloader_importing']     = 'Importando curso...';
$string['courseloader_scan_results']  = 'Resultado del escaneo';
$string['courseloader_file_type']     = 'Tipo';
$string['courseloader_file_count']    = 'Archivos';
$string['courseloader_file_names']    = 'Nombres';
$string['courseloader_warnings']      = 'Advertencias';
$string['courseloader_success']       = 'Curso importado correctamente';
$string['courseloader_go_to_course']  = 'Ir al curso';
$string['courseloader_error']         = 'Error durante la importacion';
$string['courseloader_no_config']     = 'Configura las credenciales de SharePoint en los ajustes del plugin antes de usar el cargador.';
$string['courseloader_course_sp']     = 'Curso en SharePoint';
$string['courseloader_search_course'] = 'Buscar curso...';
$string['courseloader_companies']     = 'Empresas de destino';
$string['courseloader_search_company'] = 'Buscar empresa...';
$string['courseloader_company']       = 'Empresa';
$string['courseloader_shortname']     = 'Nombre corto';
$string['courseloader_courses_available'] = '{$a} cursos disponibles';
$string['courseloader_synced']        = 'Sincronizado';
$string['courseloader_sync']         = 'Sincronizar';
$string['courseloader_syncing']      = 'Sincronizando...';
$string['courseloader_sync_done']    = 'Sincronización completada. Recargando...';
$string['courseloader_select_company'] = 'Selecciona al menos una empresa de destino.';
$string['courseloader_type_mbz']      = 'Backup Moodle (MBZ)';
$string['courseloader_type_scorm']    = 'Paquetes SCORM';
$string['courseloader_type_pdf']      = 'Documentos PDF';
$string['courseloader_type_documents'] = 'Documentos plataforma';
$string['courseloader_type_aiken']    = 'Evaluaciones AIKEN';
$string['courseloader_type_gift']     = 'Evaluaciones GIFT';
$string['courseloader_step_mbz']      = 'Restaurando backup MBZ...';
$string['courseloader_step_scorm']    = 'Configurando paquetes SCORM con URL externa...';
$string['courseloader_step_resources'] = 'Creando recursos enlazados...';
$string['courseloader_step_eval']     = 'Importando evaluaciones...';
$string['courseloader_import_courses'] = 'Importar cursos desde SharePoint';
