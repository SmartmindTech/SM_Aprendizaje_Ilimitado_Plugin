...
$string['achievement_first_activity_name']  = 'Primer paso';
$string['achievement_first_activity_desc']  = 'Completa tu primera actividad.';
$string['achievement_first_course_name']    = 'Graduación';
$string['achievement_first_course_desc']    = 'Completa tu primer curso.';
$string['achievement_activities_10_name']   = 'En marcha';
$string['achievement_activities_10_desc']   = 'Completa 10 actividades.';
$string['achievement_activities_50_name']   = 'Maratón de aprendizaje';
$string['achievement_activities_50_desc']   = 'Completa 50 actividades.';
$string['achievement_activities_100_name']  = 'Centurión';
$string['achievement_activities_100_desc']  = 'Completa 100 actividades.';
$string['achievement_courses_3_name']       = 'Coleccionista';
$string['achievement_courses_3_desc']       = 'Completa 3 cursos.';
$string['achievement_courses_10_name']      = 'Estudiante experto';
$string['achievement_courses_10_desc']      = 'Completa 10 cursos.';
$string['achievement_courses_25_name']      = 'Maestro del catálogo';
$string['achievement_courses_25_desc']      = 'Completa 25 cursos.';
$string['achievement_streak_3_name']        = 'En racha';
$string['achievement_streak_3_desc']        = 'Mantén una racha de 3 días.';
$string['achievement_streak_7_name']        = 'Constancia semanal';
$string['achievement_streak_7_desc']        = 'Mantén una racha de 7 días.';
$string['achievement_streak_30_name']       = 'Imparable';
$string['achievement_streak_30_desc']       = 'Mantén una racha de 30 días.';
$string['achievement_hours_10_name']        = 'Diez horas de vuelo';
$string['achievement_hours_10_desc']        = 'Acumula 10 horas de aprendizaje.';
$string['achievement_hours_50_name']        = 'Veterano';
$string['achievement_hours_50_desc']        = 'Acumula 50 horas de aprendizaje.';
$string['achievement_hours_100_name']        = 'Erudito';
$string['achievement_hours_100_desc']        = 'Acumula 100 horas de aprendizaje.';
$string['achievement_xp_1000_name']         = 'Mil puntos';
$string['achievement_xp_1000_desc']         = 'Alcanza 1.000 XP.';
$string['achievement_xp_5000_name']         = 'Leyenda viva';
$string['achievement_xp_5000_desc']         = 'Alcanza 5.000 XP.';

// ── Gamification: missions ──
$string['mission_daily_visit_name']             = 'Pasarse por aquí';
$string['mission_daily_visit_desc']             = 'Entra hoy en la plataforma.';
$string['mission_daily_complete_1_name']        = 'Pequeño avance';
$string['mission_daily_complete_1_desc']        = 'Completa 1 actividad hoy.';
$string['mission_daily_complete_3_name']        = 'En racha';
$string['mission_daily_complete_3_desc']        = 'Completa 3 actividades hoy.';
$string['mission_weekly_complete_5_name']       = 'Aprendiz constante';
$string['mission_weekly_complete_5_desc']       = 'Completa 5 actividades esta semana.';
$string['mission_weekly_streak_5_name']         = 'Cinco días seguidos';
$string['mission_weekly_streak_5_desc']         = 'Mantén una racha de inicio de sesión de 5 días.';
$string['mission_weekly_complete_course_name']  = 'Cierra un curso';
$string['mission_weekly_complete_course_desc']  = 'Termina 1 curso esta semana.';
