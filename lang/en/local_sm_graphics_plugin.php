...
$string['course_hours_help']       = 'Duración en horas que se muestra en la página del curso.';
...
$string['course_category_field_help'] = 'Categoría formativa SmartMind para este curso.';
...
$string['completion_percentage']      = 'Porcentaje de completado';
$string['completion_percentage_help'] = 'Porcentaje del curso que debe completarse para considerarse finalizado (0-100).';
$string['landing_level']              = 'Nivel';
$string['landing_completion']         = 'Completado';
$string['landing_edit']               = 'Editar ajustes del curso';
...
$string['landing_delete_confirm']     = '¿Seguro que quieres eliminar esta actividad? Esta acción no se puede deshacer.';
...
$string['landing_genially_url_hint']  = 'Pega la URL de embed de Genially (ej: https://view.genial.ly/...)';
...
$string['landing_video_upload_hint']  = 'Haz clic o arrastra un archivo de vídeo aquí (mp4, webm, ogg, mov...)';
$string['landing_start']              = 'Empezar curso';
$string['landing_continue']           = 'Continuar curso';
$string['landing_next_activity']      = 'Siguiente actividad';
$string['landing_unenrol']            = 'Desmatricularse';
$string['landing_unenrol_confirm_title'] = 'Confirmar desmatriculación';
$string['landing_unenrol_confirm']    = '¿Seguro que quieres desmatricularte de este curso? Se perderá tu progreso.';
