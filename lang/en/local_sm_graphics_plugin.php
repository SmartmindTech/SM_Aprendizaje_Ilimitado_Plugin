...
$string['achievement_first_activity_name']  = 'First step';
$string['achievement_first_activity_desc']  = 'Complete your first activity.';
$string['achievement_first_course_name']    = 'Graduation';
$string['achievement_first_course_desc']    = 'Complete your first course.';
$string['achievement_activities_10_name']   = 'Getting started';
$string['achievement_activities_10_desc']   = 'Complete 10 activities.';
$string['achievement_activities_50_name']   = 'Learning marathon';
$string['achievement_activities_50_desc']   = 'Complete 50 activities.';
$string['achievement_activities_100_name']  = 'Centurion';
$string['achievement_activities_100_desc']  = 'Complete 100 activities.';
$string['achievement_courses_3_name']       = 'Collector';
$string['achievement_courses_3_desc']       = 'Complete 3 courses.';
$string['achievement_courses_10_name']      = 'Expert student';
$string['achievement_courses_10_desc']      = 'Complete 10 courses.';
$string['achievement_courses_25_name']      = 'Catalog master';
$string['achievement_courses_25_desc']      = 'Complete 25 courses.';
$string['achievement_streak_3_name']        = 'On a roll';
$string['achievement_streak_3_desc']        = 'Maintain a 3-day streak.';
$string['achievement_streak_7_name']        = 'Weekly warrior';
$string['achievement_streak_7_desc']        = 'Maintain a 7-day streak.';
$string['achievement_streak_30_name']       = 'Unstoppable';
$string['achievement_streak_30_desc']       = 'Maintain a 30-day streak.';
$string['achievement_hours_10_name']        = 'Ten flight hours';
$string['achievement_hours_10_desc']        = 'Accumulate 10 hours of learning.';
$string['achievement_hours_50_name']        = 'Veteran';
$string['achievement_hours_50_desc']        = 'Accumulate 50 hours of learning.';
$string['achievement_hours_100_name']       = 'Scholar';
$string['achievement_hours_100_desc']       = 'Accumulate 100 hours of learning.';
$string['achievement_xp_1000_name']         = 'A thousand points';
$string['achievement_xp_1000_desc']         = 'Reach 1,000 XP.';
$string['achievement_xp_5000_name']         = 'Living legend';
$string['achievement_xp_5000_desc']         = 'Reach 5,000 XP.';

// ── Gamification: missions ──
$string['mission_daily_visit_name']             = 'Drop by';
$string['mission_daily_visit_desc']             = 'Visit the platform today.';
$string['mission_daily_complete_1_name']        = 'Small step';
$string['mission_daily_complete_1_desc']        = 'Complete 1 activity today.';
$string['mission_daily_complete_3_name']        = 'On a roll';
$string['mission_daily_complete_3_desc']        = 'Complete 3 activities today.';
$string['mission_weekly_complete_5_name']       = 'Steady learner';
$string['mission_weekly_complete_5_desc']       = 'Complete 5 activities this week.';
$string['mission_weekly_streak_5_name']         = 'Five in a row';
$string['mission_weekly_streak_5_desc']         = 'Maintain a 5-day login streak.';
$string['mission_weekly_complete_course_name']  = 'Wrap a course';
$string['mission_weekly_complete_course_desc']  = 'Finish 1 course this week.';
