...
export const ACTIVITY_TYPE_GROUPS: ActivityTypeGroup[] = [
  {
    ...
    types: [
      ...
      { mod: 'imscp',       iconClass: 'icon-archive',           i18nKey: 'landing.activityType.imscp', layout: 'file', fileAccept: '.zip' },
  ...
  },
  {
    ...
    types: [
      ...
      { mod: 'assign',           iconClass: 'icon-pencil',         i18nKey: 'landing.activityType.assign', layout: 'deferred' },
      ...
      { mod: 'wiki',             iconClass: 'icon-globe',               i18nKey: 'landing.activityType.wiki', layout: 'deferred' },
  ...
  },
  {
    ...
    color: '#ec4899',
    types: [
      { mod: 'trainingevent', iconClass: 'icon-calendar', i18nKey: 'landing.activityType.trainingevent', layout: 'deferred' },
    ],
  },
]
